...
public class RevenueAggregationReducer extends Reducer<Text, Text, Text, NullWritable> {
    ...
    public void reduce(org.apache.hadoop.io.Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        long viewsSum = 0L;
        long likesSum = 0L;
        long dislikesSum = 0L;
        long commentSum = 0L;
